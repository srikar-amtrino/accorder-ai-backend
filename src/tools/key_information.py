...
def get_key_information_stream(content: str, session_id: str) -> Any:
    ...
    async def event_stream() -> Any:
        async for chunk in llm_model.generate_stream(prompt=_KEY_INFO_USER, context={"contract_text": content}, session_id=session_id, system_message=_KEY_INFO_SYSTEM):
