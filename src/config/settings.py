...
class Settings(BaseSettings):
    ...
    # API settings
    api_host: str = Field(default="localhost", description="Interface the FastAPI server binds to. '0.0.0.0' listens on all interfaces (needed for EC2/external access); 'localhost' for local-only.")
